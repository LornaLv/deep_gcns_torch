...
def main():
    ...
    argparser.add_argument("--n-runs", type=int, default=5, help="running times")
    ...
    argparser.add_argument('--data_root_dir', type=str, default='default',
    ...
    # Adjust kd_dir here
    args.kd_dir = '{}/-L{}-H{}-Ptrn_{}'.format(args.kd_dir, args.n_layers, args.n_hidden,
                                               not args.pretrain_path == 'None')

    args.save = '{}/-L{}-H{}-Ptrn_{}'.format(args.kd_dir, args.n_layers, args.n_hidden,
                                             not args.pretrain_path == 'None')
...
#  ******************************Teacher******************************
"""
Namespace(alpha=0.5, attn_drop=0.0, backbone='rev', cpu=False, dropout=0.75, 
edge_drop=0.3, gpu=0, group=2, input_drop=0.25, kd_dir='./kd', log_every=20, 
lr=0.002, mask_rate=0.5, mode='teacher', n_epochs=2000, n_heads=3, 
n_hidden=256, n_label_iters=1, n_layers=5, n_runs=10, no_attn_dst=True, plot_curves=False, 
save='log/kd-L5-DP0.75-H256-20210620-044728-d9034b17-88b2-45fb-bfd2-bdc7d6de3313', 
save_pred=False, seed=0, temp=1.0, use_labels=True, use_norm=True, wd=0)
"""
#  Runned 10 times
#  Val Accs:
